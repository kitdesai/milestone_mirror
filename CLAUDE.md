...
- **Database:** Cloudflare D1 (SQLite) - users, sessions, children, frames, frame_images
...
- Auth uses PBKDF2 password hashing via Web Crypto API (Edge-compatible)
...
src/lib/           - Utilities (auth, dropbox, r2, face-detection, password)
